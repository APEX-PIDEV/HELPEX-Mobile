 ...
 * @author ASUS
 */
public class ListProduitForm extends BaseFormahmed{
     Form current;
 ...
 Toolbar tb = new Toolbar(true);
    ...
    private void addButton(Image img, Produit rec, Resources res ) {
        ...
        Label nomCentretxt=  new Label("nomproduit: "+rec.getNomProduit(),"NewsTopLine2");
                Label nomadressetxt=  new Label("description: "+rec.getDescriptionProduit(),"NewsTopLine2");
createLineSeparator();
