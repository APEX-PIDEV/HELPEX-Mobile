 ...
 * @author ASUS
 */
public class ListFormationForm extends BaseFormahmed {
      Form current;
 ...
 Toolbar tb = new Toolbar(true);
      ...
      //  final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          AjouterFormationForm a = new AjouterFormationForm(res);
            a.show();
            refreshTheme();
        });
        ...
        //fonction affichage 
                ...
                ArrayList<Formation>list = ServiceFormation.getInstance().affichageCentres();
    ...
    private void addButton(Image img, Formation rec, Resources res ) {
        ...
        Label nomFormation=  new Label("nomFormation: "+rec.getNomFormation(),"NewsTopLine2");
                Label description=  new Label("description: "+rec.getDescriptionFormation(),"NewsTopLine2");
createLineSeparator();
    ...
    Label lSupprimer = new Label(" ");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette formation ?","Annuler","Oui")) {
                ...
                if(ServiceFormation.getInstance().deleteCentre(rec.getId())) {
        ...
        lModifier.setTextPosition(LEFT);
         ...
         lModifier.addPointerPressedListener(l -> {
           ...
           new ModifierFormationForm(res,rec).show();
        });
        
cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
        BoxLayout.encloseX(nomFormation,lSupprimer,lModifier),
