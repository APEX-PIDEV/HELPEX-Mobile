...
public class StatistiquePieForm extends BaseFormahmed {
...
BaseFormahmed form;
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutCentreForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_feedback + nbr_centre;
        
        //values
        double prcntFeed = (nbr_feedback *100)/total;
        
        double prcntRec = (nbr_centre * 100)/total;
