...
public class ServiceOrganisation {
  ...
  String descriptionOrganisation = t.getDescriptionOrganisation();
       ...
       // int telephone=t.getTelephoneCentre();
        ...
        String url = Statics.BASE_URLoussema + "organisationaddjson?" +"description_organisation="+ t.getDescriptionOrganisation()+"&"+"email_organisation="+t.getEmailOrganisation()+"&"+"nom_org="+t.getNomOrg()+"&"+"num_tel_organisation="+t.getNumTelOrganisation()+"&"+"payment_info="+t.getPaymentInfo();
    ...
    public ArrayList<Organisation> affichageCentres() {
        String url = Statics.BASE_URLoussema + "organisationjson/";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
      ...
      */
      ...
      public boolean deleteCentre(int id ) {
        String url = Statics.BASE_URLoussema +"deleteorgjson/"+id;
    ...
    public boolean modifierCentre(Organisation t) {
        String url = Statics.BASE_URLoussema + "updateorgjson/"+t.getId()+ "?description_organisation=" + t.getDescriptionOrganisation() + "&email_organisation=" + t.getEmailOrganisation() + "&nom_org=" + t.getNomOrg() + "&num_tel_organisation=" + t.getNumTelOrganisation() + "&payment_info=" + t.getPaymentInfo();
