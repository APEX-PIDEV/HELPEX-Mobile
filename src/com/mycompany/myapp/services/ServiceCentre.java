...
public class ServiceCentre {
  ...
  String nom = t.getNomCentre();
        ...
        String url = Statics.BASE_URLahmed + "/centre/ajouterjson?nomCentre=" /*+ status + "/"*/ + nom + "&adresseCentre=" + adresse + "&emailCentre=" + email + "&telephoneCentre=" + telephone + "&siteWebCentre=" + siteweb;
    ...
    public ArrayList<Centre> affichageCentres() {
      ...
      public Centre DetailRecalamation( int id , Centre t) {
        ...
        String url = Statics.BASE_URLahmed+"/centrejson/"+id;
        req.setUrl(url);
      ...
      public boolean deleteCentre(int id ) {
        String url = Statics.BASE_URLahmed +"/centre/deletecentrejson/"+id;
    ...
    public boolean modifierCentre(Centre centre) {
        String url = Statics.BASE_URLahmed + "/centre/updatecentrejson/"+centre.getId()+ "?nomCentre=" + centre.getNomCentre() + "&adresseCentre=" + centre.getAdresseCentre() + "&emailCentre=" + centre.getEmailCentre() + "&telephoneCentre=" + centre.getTelephoneCentre() + "&siteWebCentre=" + centre.getSiteWebCentre();
