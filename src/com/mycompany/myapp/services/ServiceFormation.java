...
public class ServiceFormation {
  ...
  String nomFormation = t.getNomFormation();
        ...
        String url = Statics.BASE_URL + "/formation/ajouterformationjson?nomFormation=" /*+ status + "/"*/ + nomFormation + "&descriptionFormation=" + descriptionFormation + "&coutFormation=" + coutFormation + "&NombreDePlace=" + NombreDePlace + "&duree=" + duree;
...
//                                t.setDuree(((int) Float.parseFloat(obj.get("duree").toString())));
    ...
    public ArrayList<Formation> affichageCentres() {
        String url = Statics.BASE_URL + "/formation/allformation";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
      ...
      public Formation DetailRecalamation( int id , Formation t) {
        ...
        String url = Statics.BASE_URL+"/formationjson/"+id;
        req.setUrl(url);
      ...
      public boolean deleteCentre(int id ) {
        String url = Statics.BASE_URL +"/formation/deleteformationjson/"+id;
    ...
    public boolean modifierCentre(Formation centre) {
      //  String url = Statics.BASE_URL + "/centre/updatecentrejson/"+centre.getId()+ "?nomCentre=" + centre.getNomCentre() + "&adresseCentre=" + centre.getAdresseCentre() + "&emailCentre=" + centre.getEmailCentre() + "&telephoneCentre=" + centre.getTelephoneCentre() + "&siteWebCentre=" + centre.getSiteWebCentre();
                String url = Statics.BASE_URL + "/formation/updateformationjson/" +centre.getId()+   "?nomFormation=" /*+ status + "/"*/ + centre.getNomFormation() + "&descriptionFormation=" + centre.getDescriptionFormation() + "&coutFormation=" + centre.getCoutFormation() + "&NombreDePlace=" + centre.getNombreDePlace() + "&duree=" + centre.getDuree();
