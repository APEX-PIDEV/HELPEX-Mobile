...
public class ServiceUtilisateur {
  ...
  //singleton 
    ...
    public void signup(TextField username,TextField password,TextField email,TextField confirmPassword, ComboBox<String> roles , Resources res ) {
        ...
        String url = Statics.BASE_URLmariem+"/user/signup?username="+username.getText().toString()+"&email="+email.getText().toString()+
    ...
    public void signin(TextField email,TextField password, Resources rs ) {
        ...
        String url = Statics.BASE_URLmariem+"/user/signin?email="+email.getText().toString()+"&password="+password.getText().toString();
  ...
  //heki 5dmtha taw nhabtha ala description
    public String getPasswordByEmail(String email, Resources rs ) {
        ...
        String url = Statics.BASE_URLahmed+"/user/getPasswordByEmail?email="+email;
        req = new ConnectionRequest(url, false); //false ya3ni url mazlt matba3thtich lel server
        req.setUrl(url);
