...
public class ServiceProduit {
  ...
  String NomProduit = t.getNomProduit();
        ...
        String url = Statics.BASE_URL + "/produits/ajouterjson?NomProduit=" /*+ status + "/"*/ + NomProduit + "&EtatProduit=" + EtatProduit + "&DescriptionProduit=" + DescriptionProduit + "&localisationProduit=" + localisationProduit + "&Brand=" + Brand+ "&PrixProduit=" +PrixProduit;
    ...
    public ArrayList<Produit> affichageProduits() {
        String url = Statics.BASE_URL + "/produits/allproduits";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
      ...
      */
      ...
      public boolean deleteProduit(int id ) {
        String url = Statics.BASE_URL +"/produits/deleteproduitjson/"+id;
    ...
    public boolean modifierProduit(Produit produit) {
        String url = Statics.BASE_URL + "/produits/updateprduitjson/"+produit.getId()+ "?NomProduit=" + produit.getNomProduit() + "&EtatProduit=" + produit.getEtatProduit() + "&DescriptionProduit=" + produit.getDescriptionProduit() + "&localisationProduit=" + produit.getLocalisationProduit() + "&Brand=" + produit.getBrand()+ "&PrixProduit=" +produit.getPrixProduit();
