...
public class ServicePoste {
  ...
  String nom = t.getTitre();
        ...
        String url = Statics.BASE_URL + "ajouterjson?titre=" /*+ status + "/"*/ +nom+ "&description="+adresse;
    ...
    public ArrayList<Poste> affichagePostes() {
      ...
      public boolean deletePoste(int id ) {
        String url = Statics.BASE_URL +"deletepostejson/"+id;
    ...
    public boolean modifierPoste(Poste centre) {
        String url = Statics.BASE_URL + "updatepostejson/"+centre.getId()+ "?titre=" + centre.getTitre() + "&description=" + centre.getDecription();
